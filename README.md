...
## v5 updates
- Splash screen increased to 5.5 seconds.
- Home-screen icons rebuilt to mimic the splash-screen design.
- Histogram panel can be dragged around the camera preview.
- Camera zoom slider enabled where the phone/browser exposes zoom controls.
