...
const CACHE='photo-scout-v34';
const CORE_ASSETS=[
  './', './index.html', './index.html?v=34', './css/styles.css?v=34', './js/app.js?v=34', './js/analyser.js?v=34', './js/storage.js?v=34',
  './data/recommendations.js?v=34', './manifest.json?v=34', './version.json', './assets/icons/icon-192.png', './assets/icons/icon-512.png',
  './assets/icons/apple-touch-icon.png', './assets/icons/favicon-32.png', './assets/splash/photo-scout-v34'
];
