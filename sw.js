...
const CACHE='photo-scout-v28-field-technique';
const CORE_ASSETS=[
  './', './index.html', './index.html?v=28', './css/styles.css?v=28', './js/app.js?v=28', './js/analyser.js?v=28', './js/storage.js?v=28',
  './data/recommendations.js?v=28', './manifest.json?v=28', './version.json', './assets/icons/icon-192.png', './assets/icons/icon-512.png',
